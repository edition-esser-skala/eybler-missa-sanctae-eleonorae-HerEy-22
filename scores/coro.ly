      ...
      <<
        \new ChoirStaff \with { \setGroupDistance #13 #15 } <<
          ...
          \new Staff {
            ...
            \new Voice = "AltoI" { \dynamicUp \BenedictusAltoI }
          }
          \new Lyrics \lyricsto AltoI \BenedictusAltoILyrics

          \new Staff \with { \setStaffDistance #20 } {
            \set Staff.instrumentName = "A 2"
            \new Voice = "AltoII" { \dynamicUp \BenedictusAltoII }
          }
          \new Lyrics \lyricsto AltoII \BenedictusAltoIILyrics

          \new Staff {
            \set Staff.instrumentName = "T 1"
            \new Voice = "TenoreI" { \dynamicUp \BenedictusTenoreI }
          }
          \new Lyrics \lyricsto TenoreI \BenedictusTenoreILyrics

          \new Staff {
            \set Staff.instrumentName = "T 2"
            \new Voice = "TenoreII" { \dynamicUp \BenedictusTenoreII }
          }
          \new Lyrics \lyricsto TenoreII \BenedictusTenoreIILyrics

          \new Staff {
            \set Staff.instrumentName = "B 1"
            \new Voice = "BassoI" { \dynamicUp \BenedictusBassoI }
          }
          \new Lyrics \lyricsto BassoI \BenedictusBassoILyrics

          \new Staff {
            \set Staff.instrumentName = "B 2"
            \new Voice = "BassoII" { \dynamicUp \BenedictusBassoII }
          }
          \new Lyrics \lyricsto BassoII \BenedictusBassoIILyrics
        >>
