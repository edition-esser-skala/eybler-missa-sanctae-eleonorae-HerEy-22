...
AgnusSoprano = {
  \relative c' {
    ...
    d4 e8 a,([ h)] cis
    d4( e8) fis r r %75
    fis,4\p fis8 fis([ e)] fis
    g4. fis8 r r
    h([ g)] e d4( \grace fis16 e8)
    d r r fis4 e8
    e([ d)] d a'4 g8 %80
    g([\cresc fis)] fis c'!4 a8
    e'4.~\f e8[ c] a
    g4\p fis8 e([ a)] g
    fis([ e')] d d([ c)] h
    r d, g g4 fis8 %85
