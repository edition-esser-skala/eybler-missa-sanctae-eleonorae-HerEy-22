...
KyrieBassFigures = \figuremode {
  ...
  <6!>2 <4\+ 2\+>8 \bc <[5 3 _]>4.
  r1
  r4 \bo <[6 _]>8 <7>4 <9 7>8 <7 5> <5 3>
  <6>4. <5>8 <6!>4. <5>8
...
BenedictusOrgano = {
  \relative c {
    ...
    c8 r r4
    R2*6 %55
    \clef "treble_8" r8^\vlc a'(\p^\arco b) b,
    f' r r4
    r2
    \clef bass r8^\bassiE b,^\pizz b r
    r f' f r %60
    r b b r
    R2
    r8 f(^\arco fis g)
...
AgnusOrgano = {
  \relative c {
    ...
    d,4 d' r
    r8 d,\p d d d d
    es es e\espressivo e e e %15
    f\pp f f f f, f
    b4 r8 b b b
    c4 r8 c c c
    d4 r8 d d d
    es es f f f, f %20
    b r r4 \clef "treble_8" e
    f8( g as f) \clef bass b,4
    c8( des c b\cresc as g)
    f4 r f'\p
    e2 r4 %25
    R2.*2
    r4 f,( as
    ...
    c,4 c' r
    r8 c,\p c c c c
    des des d\espressivo d d d
    es\pp es es es es, es
    as4 r8 \hA as as as %40
    b4 r8 b b b
    c4 r8 c c c
    des des es es es, es
    \mvTrr as\mf-\tutti as as as as as
    g g' g g g g %45
    f f f f es es
    h h c c c c
    c\fz c' c c c c
    ...
    a, a b b es, es %50
    d4 d' r
    r r r8 \clef "treble_8" a'(-\senzaOrg
    c![\espressivo b! a g fis)] \clef bass c'(
    es\espressivo d c b a g) \noBreak
    fis( e d c h a) \bar "||" %55
    \key g \major \time 6/8 \tempoDona \newSpacingSection
      g8 r r r4 r8 \noBreak
    R2.
    r8 \mvTr g\p-\solo h d d, d'
    r d fis g g, g'
    r g g c,4\cresc c8 %60
    d e fis g h, d
    \mvTr g\f-\tutti g, a' g g, fis'
    e fis g a a, a'
    a, a' a a, a' a
    a, cis d a' e \hA cis %65
    a a' a a, a' a
    a, a' a a, a' a
    a, a' a a, a' a
    a, a' a a, a' a
    ...
    g g' g, a a' a,
    h h' g, a a' g,
    fis fis' e, d d' cis %75
    \mvTr h4\p-\solo h8 h4 h8
    ais4. h4 a8
    g4. a
    d,8 d' d d, d' d
    d, d' d d, d' d %80
    d,\cresc d' d d, d' d
    \mvTr d,\f-\tutti d' d d e fis
    g r r r4 r8
    R2.
    r8 \mvTr g,\p-\solo h d d, d' %85
    r d fis g g, g'
    g, g' g c,,\cresc c' c
    d e fis g e h
    \mvTr c\f-\tutti c' d, c c' h,
    a h c d, d' d %90
    d, d' d d, d' d
    d fis g d a fis
    d d' d d, d' d
    ...
    d d, d' e e, e'
    fis fis, fis' g g, fis'
    \mvTr e4\p-\solo e8 e4 e8
    dis4. e4 r8
    c4. d %105
    g,4 g8 g4 g8
    g g' g g, g' g
    g,\cresc g' g g, g' g
    \mvTr g,\f-\tutti g' g g, g' g
    g, g' g g, g' g %110
    c, c' c d, d' d
    e, e' e c, c' c
    d4 r8 d,4 r8
...
AgnusBassFigures = \figuremode {
  ...
  r <6 4>4 <[5] _+>8
  <7 _+>4 <6 4>8 <\t \t>4 <[5] _+>8
  <7> <\t> <3> <_+>4 \once \bassFigureExtendersOn q8 %65
  <7 _+>2.
  <\t \t>
  <6 4>
  <\t \t>
  ...
  <\t \t> <8 3>2 <7\\ 4>8 %80
  <\t \t> <8 3>4 \bc <[7! _]>4.
  <7 _+>4. \bassFigureExtendersOn <7 _+\!>8 <7 3\!> q \bassFigureExtendersOff
  r2.
  r
  r4. \bo <[6 4]>4 <5 3>8 %85
  r4. <9 4>4 <8 3>8
  r2.
  <8 6>8 <7 5> <5 3>4 <6>8 \bc <[6 5!]>
  r4 <4\+ _!>8 <6>4 <6\\>8
  r4. <6 4!>4 <[5] _+>8 %90
  <7>4 <6 4>8 <\t \t>4 <5 _+>8
  <7> <\t> <3> <_+>4 \once \bassFigureExtendersOn q8
  <7>4. <\t>
  q2.
  <6 4> %95
  <\t \t>
